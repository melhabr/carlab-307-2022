...
module top ;
	...
	cy_clock_v1_0
		#(.id("a03d663b-fba6-4d89-82f4-b96cb96b5df7"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Motor_Pin_net;
	wire [0:0] tmpFB_0__Motor_Pin_net;
	wire [0:0] tmpIO_0__Motor_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Motor_Pin_net;
	electrical [0:0] tmpSIOVREF__Motor_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("5b31f17c-69bd-4f57-a6d9-621495028602"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_Pin
		 (.oe(tmpOE__Motor_Pin_net),
		  .y({Net_220}),
		  .fb({tmpFB_0__Motor_Pin_net[0:0]}),
		  .io({tmpIO_0__Motor_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Motor_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_80_3 PWM_Timer (
        ...
        .tc(Net_183),
        .clock(Net_257));
    defparam PWM_Timer.CaptureCount = 2;
    defparam PWM_Timer.CaptureCounterEnabled = 0;
    defparam PWM_Timer.DeviceFamily = "PSoC5";
    defparam PWM_Timer.InterruptOnCapture = 0;
    defparam PWM_Timer.InterruptOnTC = 1;
    defparam PWM_Timer.Resolution = 16;
    defparam PWM_Timer.SiliconRevision = "0";
