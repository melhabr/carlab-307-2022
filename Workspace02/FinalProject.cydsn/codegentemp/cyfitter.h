...
#define PWM_Timer_TimerHW__CAP0 CYREG_TMR0_CAP0
#define PWM_Timer_TimerHW__CAP1 CYREG_TMR0_CAP1
#define PWM_Timer_TimerHW__CFG0 CYREG_TMR0_CFG0
#define PWM_Timer_TimerHW__CFG1 CYREG_TMR0_CFG1
#define PWM_Timer_TimerHW__CFG2 CYREG_TMR0_CFG2
#define PWM_Timer_TimerHW__CNT_CMP0 CYREG_TMR0_CNT_CMP0
#define PWM_Timer_TimerHW__CNT_CMP1 CYREG_TMR0_CNT_CMP1
#define PWM_Timer_TimerHW__PER0 CYREG_TMR0_PER0
#define PWM_Timer_TimerHW__PER1 CYREG_TMR0_PER1
#define PWM_Timer_TimerHW__PM_ACT_CFG CYREG_PM_ACT_CFG3
#define PWM_Timer_TimerHW__PM_ACT_MSK 0x01u
#define PWM_Timer_TimerHW__PM_STBY_CFG CYREG_PM_STBY_CFG3
#define PWM_Timer_TimerHW__PM_STBY_MSK 0x01u
#define PWM_Timer_TimerHW__RT0 CYREG_TMR0_RT0
#define PWM_Timer_TimerHW__RT1 CYREG_TMR0_RT1
#define PWM_Timer_TimerHW__SR0 CYREG_TMR0_SR0
...
/* Motor_Pin */
#define Motor_Pin__0__INTTYPE CYREG_PICU4_INTTYPE1
#define Motor_Pin__0__MASK 0x02u
#define Motor_Pin__0__PC CYREG_PRT4_PC1
#define Motor_Pin__0__PORT 4u
#define Motor_Pin__0__SHIFT 1u
#define Motor_Pin__AG CYREG_PRT4_AG
#define Motor_Pin__AMUX CYREG_PRT4_AMUX
#define Motor_Pin__BIE CYREG_PRT4_BIE
#define Motor_Pin__BIT_MASK CYREG_PRT4_BIT_MASK
#define Motor_Pin__BYP CYREG_PRT4_BYP
#define Motor_Pin__CTL CYREG_PRT4_CTL
#define Motor_Pin__DM0 CYREG_PRT4_DM0
#define Motor_Pin__DM1 CYREG_PRT4_DM1
#define Motor_Pin__DM2 CYREG_PRT4_DM2
#define Motor_Pin__DR CYREG_PRT4_DR
#define Motor_Pin__INP_DIS CYREG_PRT4_INP_DIS
#define Motor_Pin__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU4_BASE
#define Motor_Pin__LCD_COM_SEG CYREG_PRT4_LCD_COM_SEG
#define Motor_Pin__LCD_EN CYREG_PRT4_LCD_EN
#define Motor_Pin__MASK 0x02u
#define Motor_Pin__PORT 4u
#define Motor_Pin__PRT CYREG_PRT4_PRT
#define Motor_Pin__PRTDSI__CAPS_SEL CYREG_PRT4_CAPS_SEL
#define Motor_Pin__PRTDSI__DBL_SYNC_IN CYREG_PRT4_DBL_SYNC_IN
#define Motor_Pin__PRTDSI__OE_SEL0 CYREG_PRT4_OE_SEL0
#define Motor_Pin__PRTDSI__OE_SEL1 CYREG_PRT4_OE_SEL1
#define Motor_Pin__PRTDSI__OUT_SEL0 CYREG_PRT4_OUT_SEL0
#define Motor_Pin__PRTDSI__OUT_SEL1 CYREG_PRT4_OUT_SEL1
#define Motor_Pin__PRTDSI__SYNC_OUT CYREG_PRT4_SYNC_OUT
#define Motor_Pin__PS CYREG_PRT4_PS
#define Motor_Pin__SHIFT 1u
#define Motor_Pin__SLW CYREG_PRT4_SLW

/* Servo_PWM */
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__16BIT_CONTROL_AUX_CTL_REG CYREG_B1_UDB05_06_ACTL
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__16BIT_CONTROL_CONTROL_REG CYREG_B1_UDB05_06_CTL
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__16BIT_CONTROL_COUNT_REG CYREG_B1_UDB05_06_CTL
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__16BIT_COUNT_CONTROL_REG CYREG_B1_UDB05_06_CTL
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__16BIT_COUNT_COUNT_REG CYREG_B1_UDB05_06_CTL
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__16BIT_MASK_MASK_REG CYREG_B1_UDB05_06_MSK
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__16BIT_MASK_PERIOD_REG CYREG_B1_UDB05_06_MSK
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__16BIT_PERIOD_MASK_REG CYREG_B1_UDB05_06_MSK
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__16BIT_PERIOD_PERIOD_REG CYREG_B1_UDB05_06_MSK
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__7__MASK 0x80u
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__7__POS 7
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__CONTROL_AUX_CTL_REG CYREG_B1_UDB05_ACTL
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__CONTROL_REG CYREG_B1_UDB05_CTL
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__CONTROL_ST_REG CYREG_B1_UDB05_ST_CTL
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__COUNT_REG CYREG_B1_UDB05_CTL
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__COUNT_ST_REG CYREG_B1_UDB05_ST_CTL
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__MASK 0x80u
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__MASK_CTL_AUX_CTL_REG CYREG_B1_UDB05_MSK_ACTL
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__PER_CTL_AUX_CTL_REG CYREG_B1_UDB05_MSK_ACTL
#define Servo_PWM_PWMUDB_genblk1_ctrlreg__PERIOD_REG CYREG_B1_UDB05_MSK
...
#define Servo_PWM_PWMUDB_sP16_pwmdp_u0__16BIT_A0_REG CYREG_B1_UDB04_05_A0
#define Servo_PWM_PWMUDB_sP16_pwmdp_u0__16BIT_A1_REG CYREG_B1_UDB04_05_A1
#define Servo_PWM_PWMUDB_sP16_pwmdp_u0__16BIT_D0_REG CYREG_B1_UDB04_05_D0
#define Servo_PWM_PWMUDB_sP16_pwmdp_u0__16BIT_D1_REG CYREG_B1_UDB04_05_D1
#define Servo_PWM_PWMUDB_sP16_pwmdp_u0__16BIT_DP_AUX_CTL_REG CYREG_B1_UDB04_05_ACTL
#define Servo_PWM_PWMUDB_sP16_pwmdp_u0__16BIT_F0_REG CYREG_B1_UDB04_05_F0
#define Servo_PWM_PWMUDB_sP16_pwmdp_u0__16BIT_F1_REG CYREG_B1_UDB04_05_F1
#define Servo_PWM_PWMUDB_sP16_pwmdp_u0__A0_A1_REG CYREG_B1_UDB04_A0_A1
#define Servo_PWM_PWMUDB_sP16_pwmdp_u0__A0_REG CYREG_B1_UDB04_A0
#define Servo_PWM_PWMUDB_sP16_pwmdp_u0__A1_REG CYREG_B1_UDB04_A1
#define Servo_PWM_PWMUDB_sP16_pwmdp_u0__D0_D1_REG CYREG_B1_UDB04_D0_D1
#define Servo_PWM_PWMUDB_sP16_pwmdp_u0__D0_REG CYREG_B1_UDB04_D0
#define Servo_PWM_PWMUDB_sP16_pwmdp_u0__D1_REG CYREG_B1_UDB04_D1
#define Servo_PWM_PWMUDB_sP16_pwmdp_u0__DP_AUX_CTL_REG CYREG_B1_UDB04_ACTL
#define Servo_PWM_PWMUDB_sP16_pwmdp_u0__F0_F1_REG CYREG_B1_UDB04_F0_F1
#define Servo_PWM_PWMUDB_sP16_pwmdp_u0__F0_REG CYREG_B1_UDB04_F0
#define Servo_PWM_PWMUDB_sP16_pwmdp_u0__F1_REG CYREG_B1_UDB04_F1
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__16BIT_A0_REG CYREG_B1_UDB05_06_A0
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__16BIT_A1_REG CYREG_B1_UDB05_06_A1
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__16BIT_D0_REG CYREG_B1_UDB05_06_D0
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__16BIT_D1_REG CYREG_B1_UDB05_06_D1
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__16BIT_DP_AUX_CTL_REG CYREG_B1_UDB05_06_ACTL
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__16BIT_F0_REG CYREG_B1_UDB05_06_F0
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__16BIT_F1_REG CYREG_B1_UDB05_06_F1
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__A0_A1_REG CYREG_B1_UDB05_A0_A1
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__A0_REG CYREG_B1_UDB05_A0
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__A1_REG CYREG_B1_UDB05_A1
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__D0_D1_REG CYREG_B1_UDB05_D0_D1
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__D0_REG CYREG_B1_UDB05_D0
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__D1_REG CYREG_B1_UDB05_D1
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__DP_AUX_CTL_REG CYREG_B1_UDB05_ACTL
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__F0_F1_REG CYREG_B1_UDB05_F0_F1
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__F0_REG CYREG_B1_UDB05_F0
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__F1_REG CYREG_B1_UDB05_F1
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__MSK_DP_AUX_CTL_REG CYREG_B1_UDB05_MSK_ACTL
#define Servo_PWM_PWMUDB_sP16_pwmdp_u1__PER_DP_AUX_CTL_REG CYREG_B1_UDB05_MSK_ACTL

/* Servo_Pin */
#define Servo_Pin__0__INTTYPE CYREG_PICU3_INTTYPE1
#define Servo_Pin__0__MASK 0x02u
#define Servo_Pin__0__PC CYREG_PRT3_PC1
#define Servo_Pin__0__PORT 3u
#define Servo_Pin__0__SHIFT 1u
#define Servo_Pin__AG CYREG_PRT3_AG
#define Servo_Pin__AMUX CYREG_PRT3_AMUX
#define Servo_Pin__BIE CYREG_PRT3_BIE
#define Servo_Pin__BIT_MASK CYREG_PRT3_BIT_MASK
#define Servo_Pin__BYP CYREG_PRT3_BYP
#define Servo_Pin__CTL CYREG_PRT3_CTL
#define Servo_Pin__DM0 CYREG_PRT3_DM0
#define Servo_Pin__DM1 CYREG_PRT3_DM1
#define Servo_Pin__DM2 CYREG_PRT3_DM2
#define Servo_Pin__DR CYREG_PRT3_DR
#define Servo_Pin__INP_DIS CYREG_PRT3_INP_DIS
#define Servo_Pin__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU3_BASE
#define Servo_Pin__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define Servo_Pin__LCD_EN CYREG_PRT3_LCD_EN
#define Servo_Pin__MASK 0x02u
#define Servo_Pin__PORT 3u
#define Servo_Pin__PRT CYREG_PRT3_PRT
#define Servo_Pin__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define Servo_Pin__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define Servo_Pin__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define Servo_Pin__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define Servo_Pin__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define Servo_Pin__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define Servo_Pin__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define Servo_Pin__PS CYREG_PRT3_PS
#define Servo_Pin__SHIFT 1u
#define Servo_Pin__SLW CYREG_PRT3_SLW

/* Servo_Clock */
#define Servo_Clock__CFG0 CYREG_CLKDIST_DCFG0_CFG0
#define Servo_Clock__CFG1 CYREG_CLKDIST_DCFG0_CFG1
#define Servo_Clock__CFG2 CYREG_CLKDIST_DCFG0_CFG2
#define Servo_Clock__CFG2_SRC_SEL_MASK 0x07u
#define Servo_Clock__INDEX 0x00u
#define Servo_Clock__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define Servo_Clock__PM_ACT_MSK 0x01u
#define Servo_Clock__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define Servo_Clock__PM_STBY_MSK 0x01u

/* Receive_Data */
#define Receive_Data__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define Receive_Data__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define Receive_Data__INTC_MASK 0x01u
#define Receive_Data__INTC_NUMBER 0u
#define Receive_Data__INTC_PRIOR_NUM 7u
#define Receive_Data__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define Receive_Data__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define Receive_Data__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
